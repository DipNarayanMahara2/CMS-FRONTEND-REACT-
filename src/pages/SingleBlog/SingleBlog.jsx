                        ...
                        <div className="p-4 absolute bottom-0 left-0 z-20">
                            ...
                            <div className="flex mt-3 justify-between items-center w-full max-w-screen-md">
                                ...
                                <div className="flex space-x-2">
                                    <Link to='/blog/update' className="px-4 py-1 bg-blue-600 text-white text-sm rounded hover:bg-blue-700 transition duration-200">
                                        Edit
                                    </Link>
                                    <button className="px-4 py-1 bg-red-600 text-white text-sm rounded hover:bg-red-700 transition duration-200">
                                        Delete
                                    </button>
                                </div>
                            </div>
